...
*** Generate data from Org-Mode file
    ...
    #+BEGIN_SRC elisp
      ...
      When called with LICENSE and/or VISIBILITY arguments, send post request with customized arguments to alter publishing behaviour."
        (interactive)
        ...
        (let* ((url-request-method "POST")
               ...
               (publish-status org-medium-default-visibility)
    ...
    This function is for reference here, will be deleted later:
