...
*** Generate data from Org-Mode file
    ...
    #+BEGIN_SRC elisp
      (defun org-sendto-medium ()                                (ref:default-sendto)
        ...
        (let* ((url-request-method "POST")
               ...
               (content-format "html")
               (license org-medium-default-license)
    ...
    The following function is mostly identical to [[(default-sendto)][the default 'send' function]], but the license variable uses user input to specify a different license from the value of default license.

    #+NAME: org-sendto-medium-with-license
    #+BEGIN_SRC elisp
      (defun org-sendto-medium-with-license ()
              "Publish your post to Medium with specified license."
              (interactive)
              (if (not (and org-medium-author-id (org-medium-test-token)))
                  (setq org-medium-author-id (org-medium-get-authorid)))
              (let* ((url-request-method "POST")
                     ...
                     (content (org-medium-get-content title))
                     (content-format "html")
                     (license (read-string "Please select license, unknown license = all rights reserved: " "all-rights-reserved" nil '("all-rights-reserved" "cc-40-by" "cc-40-by-sa" "cc-40-by-nd" "cc-40-by-nc" "cc-40-by-nc-nd" "cc-40-by-nc-sa" "cc-40-zero" "public-domain")))
                     (url-request-data (json-encode-plist `(:title ,title
                                                                   :contentFormat ,content-format
                                                                   :content ,content
                                                                   :license ,license
    ...
    Another function can be produced to send the post to Medium in a different status ("published" "draft" or "unlisted") than the default status.
