        ...
        (save-excursion
          (with-current-buffer buffer
            (let ((string (buffer-string)))
              (replace-regexp-in-string "\\\n" "" (replace-regexp-in-string "\\\\\/p" "/p" string nil t))))))
    #+END_SRC
    ...
    #+BEGIN_SRC elisp
      (defun org-sendto-medium ()
        ...
        (let* ((url-request-method "POST")
               ...
               (content (org-medium-get-content))
               (content-format "html")
